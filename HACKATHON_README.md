...
- [x] **F. IoT Integration:** Integrates simulated/streamed sensor feeds (soil moisture, temperature, humidity, pH).
...
- **IoT Hardware:** Currently utilizes a simulated data stream; physical hardware edge integration is pending.
